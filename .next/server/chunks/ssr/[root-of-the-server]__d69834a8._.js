...
"[project]/src/lib/checkUser.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const checkUser = async ()=>{
    ...
    try {
        const loggedInUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                clerkUserId: user.id
            }
        });
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].user.create({
            data: {
                clerkUserId: user.id,
                name,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$checkUser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/checkUser.js [app-rsc] (ecmascript)");
;
;
;
;
...
;
const Header = async ()=>{
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$checkUser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkUser"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d69834a8._.js.map